                    ...
                    <div className="inputs">
                        <div className="input-hours column">
                            <TimerInput
                                ...
                                field={(e) =>
                                    this.handleTime(e, 'inputHours', 3600)
                                }
                            />
                            <span>Hours</span>
                        </div>
                        <div className="input-minutes column">
                            <TimerInput
                                ...
                                field={(e) =>
                                    this.handleTime(e, 'inputMinutes', 60)
                                }
                            />
                            <span>Minutes</span>
                        </div>
                        <div className="input-seconds column">
                            <TimerInput
                                ...
                                field={(e) =>
                                    this.handleTime(e, 'inputSeconds', 1)
                                }
                            />
                            <span>Seconds</span>
                        </div>
                        ...
                        <div className="submit inline">
                            <button
                                ...
                                disabled={
                                    ...
                                    this.state.inputMinutes === 0 &&
                                    this.state.inputSeconds === '00'
                                }
                            >
                                {this.state.runningTimer === 1 &&
                                this.state.toSeconds ? (
                                    <FaRegStopCircle />
                                ) : (
                                    <FaPlay />
